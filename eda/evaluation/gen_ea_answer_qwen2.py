"""Generate answers with EAGLE for Qwen2.5 models on MT-Bench.

Usage:
python gen_ea_answer_qwen2.py --base-model-path /path/to/qwen2.5 --ea-model-path /path/to/eagle
"""
import argparse
import json
import os
...
from eda.model.ea_model import EaModel
...
def get_model_answers(
    ...
    if all_accept_lengths:
        ...
        print("\n" + "="*60)
        print("EAGLE Accept Length Statistics on MT-Bench")
        print("="*60)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ea-model-path",
        type=str,
        default="/gemini/platform/public/linlx/moe_eagle/models/state_20",
        help="The path to the EAGLE model weights.",
    )
    parser.add_argument(
        "--base-model-path", 
        type=str, 
    ...
    parser.add_argument("--model-id", type=str, default="qwen25_7b_eagle")
    parser.add_argument(
        "--bench-name",
        type=str,
        default="mt_bench",
    ...
    print(f"EAGLE model: {args.ea_model_path}")
